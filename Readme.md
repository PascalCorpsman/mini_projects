...
### Some Projects also have precompiled binaries, they can be found [here](https://github.com/PascalCorpsman/mini_projects/releases/tag/latest)
...
| [FPC_CPU](miniprojects/FPC_CPU) | Demo to show how a CPU works internally |
